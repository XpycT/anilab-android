 ...
 *
 */
public class ScreenshotsViewPager extends ViewPager {

    private boolean isLocked;

    public ScreenshotsViewPager(Context context) {
        super(context);
        isLocked = false;
    }

    public ScreenshotsViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        isLocked = false;
    }
