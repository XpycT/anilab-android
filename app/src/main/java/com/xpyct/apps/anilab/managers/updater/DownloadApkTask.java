...
public class DownloadApkTask extends AsyncTask<String, Integer, String> {
    ...
    public DownloadApkTask(Context context, ProgressDialog dialog) {
        this.context = context;
    ...
    protected String doInBackground(String... sUrl) {
        ...
        try {
            ...
            File tmpFile = new File(context.getExternalCacheDir(), "anilab-latest.apk");
            if (tmpFile.exists()) {
                tmpFile.delete();
            }
    ...
    protected void onPostExecute(String result) {
        ...
        if (result != null)
            ...
            if (this.listener != null)
                ...
                Toast.makeText(context, "File downloaded at : " + this.filePath, Toast.LENGTH_LONG).show();
